...
def main():
    ...
    logger.info(f"Attempting to get a generative answer from namespace: '{target_namespace}'")
    ...
    try:
        ...
        with client:
            ...
            if response and 'answer' in response:
                 ...
                 logger.warning("Request completed, but response format might be unexpected or missing 'answer'.")
